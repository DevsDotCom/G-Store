...
<div class="container pb-16">
    <h2 class="text-2xl md:text-3xl font-medium text-gray-800 uppercase mb-6 mt-8">{{ $category->name }}</h2>
    @if ($products->count() > 0)
        <!-- product wrapper -->
        ...
        <!-- product wrapper end -->
        @else 
            <div class="text-red-500">There are no products in this category.</div>
        @endif
    </div>
    <!-- top new arrival end -->
@endsection